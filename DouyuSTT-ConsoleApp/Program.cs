...
namespace DouyuSTT_ConsoleApp
{
    class Program
    {
        ...
        {
            Console.WriteLine("测试存在的Key Value获取(string)...");
            ...
            Console.WriteLine("测试不存在的Key Value获取(string)...");
            Console.WriteLine($"消息类型: {data.Get("typo")}");
            Console.WriteLine("测试存在的Key Value获取(int)...");
            Console.WriteLine($"sid: {data.GetInt("sid")}");
            Console.WriteLine("测试不存在的Key Value获取(int)...");
            Console.WriteLine($"消息类型: {data.GetInt("typo")}");
        }
    }
}
